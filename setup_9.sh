...
docker run -v /etc/:/root/docker_etc/ -d --network=host --name=9hits 9hitste/app /nh.sh --token=7bb1440ac55eeb5221d7d68c87d33406 --system-session --ex-proxy-sessions=32 --allow-crypto=no --session-note=$systemID --note=$systemID --hide-browser --cache-del=100
